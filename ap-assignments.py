...
device_times = {
    'nexus-4': {
        ...
        'runtestsremote.py Mdm1':        {'opt':  4, 'debug':  15, 'fraction': 0.17},
        'runtestsremote.py Mdm1 opt':    {'opt':  4, 'debug':  0, 'fraction': 0.17},
        'runtestsremote.py Mdm1 debug':  {'opt':  0, 'debug':  15, 'fraction': 0.17},
    ...
    'nexus-5': {
        ...
        'runtestsremote.py Cdm4 opt':    {'opt':  1, 'debug':  0, 'fraction': 0.17},
        'runtestsremote.py Cdm4 debug':  {'opt':  0, 'debug':  1, 'fraction': 0.17},
        'runtestsremote.py Mdm1':        {'opt':  7, 'debug': 10, 'fraction': 0.17},
        'runtestsremote.py Mdm1 opt':    {'opt':  7, 'debug':  0, 'fraction': 0.17},
