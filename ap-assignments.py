...
device_times = {
    'nexus-4': {
        ...
        'runtestsremote.py Mdm':      {'opt': 4, 'debug': 4},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
    ...
    'nexus-5': {
        ...
        'runtestsremote.py Mdm':      {'opt': 6, 'debug': 10},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
    ...
    'nexus-6': {
        ...
        'runtestsremote.py Mdm':      {'opt': 6, 'debug': 16},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
    ...
    'nexus-6p': {
        ...
        'runtestsremote.py Mdm':      {'opt': 6, 'debug': 9},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
    ...
    'nexus-9': {
        ...
        'runtestsremote.py M':        {'opt': 0, 'debug': 0},
        'runtestsremote.py Mdb':      {'opt': 1, 'debug': 2},
        'runtestsremote.py Mdm':      {'opt': 6, 'debug': 8},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
        'runtestsremote.py Mw':       {'opt': 10, 'debug': 10},
    ...
    'pixel': {
        ...
        'runtestsremote.py M':        {'opt': 0, 'debug': 0},
        'runtestsremote.py Mdb':      {'opt': 1, 'debug': 2},
        'runtestsremote.py Mdm':      {'opt': 5, 'debug': 9},
        'runtestsremote.py Mm':       {'opt': 2, 'debug': 2},
        'runtestsremote.py Mw':       {'opt': 3, 'debug': 6},
        'runtestsremote.py Msk':      {'opt': 2, 'debug': 2},
        'runtestsremote.py Mtw':      {'opt': 1, 'debug': 1},
